...
def generate_launch_description():
	...
	xacro_path = os.path.join(get_package_share_directory('trr_robot'), 'description', 'trr_robot.xacro')
	...
	rviz = Node(
		...
		name='rviz2',
		output='screen',
		arguments=['-d', os.path.join(get_package_share_directory('trr_robot'), 'config', 'view_bot.rviz')]
	)
