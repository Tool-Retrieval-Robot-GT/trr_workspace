...
constexpr int MOTOROUT = 11;      // Motor PWM out
constexpr int DIRECTION = 12;     // Direction pin out

constexpr int TOPSWITCH = 9;      // Top sensor switch
constexpr int BOTTOMSWITCH = 10;  // Bottom sensor switch

constexpr int ENCODER1 = 2;       // First encoder pin
constexpr int ENCODER2 = 3;       // Second encoder pin

constexpr int MOTORSPEED = 100;   // Set the motor speed

int encoderCount = 0;             // Encoder count
